...
Хотел сделать сервис пользователя, чтобы можно было регестрироваться/логиниться и получать токен, с которым затем можно было обращаться к некоторым методам.
